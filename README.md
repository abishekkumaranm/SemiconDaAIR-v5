...
`SemiconDaAIR-v5` (*Semiconductor Degradation-Aware Adaptive Image Restoration*) is an ultra-lightweight, physics-guided deep neural network prototype engineered for real-time microscopic semiconductor inspection. It addresses three simultaneous physical image degradations encountered in sub-5nm wafer die scanning:
